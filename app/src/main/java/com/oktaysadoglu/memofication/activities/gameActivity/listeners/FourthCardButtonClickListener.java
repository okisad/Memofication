 ...
 */
public class FourthCardButtonClickListener extends CardButtonClickListener {
    ...
    public FourthCardButtonClickListener(Context context, ViewGroup parent, SwipeDeck cardStack, List<Button> buttonsBundle, WordCard wordCard) {
        super(context,parent,cardStack,buttonsBundle,wordCard);

        setButton(buttonsBundle.get(3));
    ...
    public void onClick(View v) {
        ...
        setWordId(getWordCard().getWords().get(3).getId());
