 ...
 */
public class GameActivityReverse extends GameActivity{
    ...
    public void fillWordAndOptions(View view, int position) {
        ...
        mainWordText.setText(getWordCards().get(position).getMainWord().getMean());

        firstOption.setText(getWordCards().get(position).getWords().get(0).getWord());
        secondOption.setText(getWordCards().get(position).getWords().get(1).getWord());
        thirdOption.setText(getWordCards().get(position).getWords().get(2).getWord());
        fourthOption.setText(getWordCards().get(position).getWords().get(3).getWord());
    }
